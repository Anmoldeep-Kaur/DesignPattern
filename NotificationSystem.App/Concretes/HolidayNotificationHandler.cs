...
{
    public class HolidayNotificationHandler : INotificationHandler
    {
        private const string MessageTemplate =
            "On {0} the office will remain closed due to {1}";
        ...
        public void create(List<Events> events)
        {
            ...
            {
                string notificationMsg = string.Format(MessageTemplate, e.EventDate.Date, e.EventName);
